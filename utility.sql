...
--line 20 need number of participants & line 21 needs password set
...
set num_users = 2; --> adjust number of attendees here
set lab_pwd = ''; --> enter an attendee password here
...
call utility.public.loopquery('grant ownership on schema HOL.PUBLIC to role roleXXX revoke current grants;', $num_users);
...
call utility.public.loopquery('GRANT operate ON warehouse whXXX TO ROLE roleXXX', $num_users);
call utility.public.loopquery('GRANT monitor ON warehouse whXXX TO ROLE roleXXX', $num_users);
call utility.public.loopquery('GRANT modify ON warehouse whXXX TO ROLE roleXXX', $num_users);
